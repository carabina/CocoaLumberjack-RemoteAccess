...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/CocoaLumberjack-RemoteAccess'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'tomcat2088' => 'tomcat1991@126.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/CocoaLumberjack-RemoteAccess.git', :tag => s.version.to_s }
